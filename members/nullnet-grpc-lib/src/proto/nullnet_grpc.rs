...
pub struct NetType {
    ...
    pub egress_allow_tcp_ports: ::prost::alloc::vec::Vec<u32>,
    #[prost(uint32, repeated, tag = "5")]
    pub egress_allow_udp_ports: ::prost::alloc::vec::Vec<u32>,
    #[prost(bool, tag = "6")]
